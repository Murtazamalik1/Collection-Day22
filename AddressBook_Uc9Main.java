...
public class AddressBook_Uc9Main {
    static Scanner scr = new Scanner(System.in);
    static AddressBook_Uc9 addressBook;
    static HashMap<String, AddressBook_Uc9> map = new HashMap<>();
        ...
        switch (option) {
            case 1:
                ...
                if (map.containsKey(addressBookName)) {
                    ...
                    addressBook = new AddressBook_Uc9();
