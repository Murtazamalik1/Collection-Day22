...
public class AddressBook_Uc10Main {
    static Scanner scr = new Scanner(System.in);
    static AddressBook_Uc10 addressBook;
    static HashMap<String, AddressBook_Uc10> map = new HashMap<>();
        ...
        switch (option) {
            case 1:
                ...
                if (map.containsKey(addressBookName)) {
                    ...
                    addressBook = new AddressBook_Uc10();
